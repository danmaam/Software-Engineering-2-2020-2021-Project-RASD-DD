...
\section{Formal Analysis Using Alloy}
	...
	\begin{figure}
		\begin{adjustwidth} {-3cm}{}
			...
			\caption{Department Capacity respected. In this model, it's shown that the parameters of capacity and maximum allowed booked customers are respected.}
		\end{adjustwidth}
	\end{figure}
	...
	\begin{adjustwidth} {-3cm}{}
		...
		\caption{Coherent reservations status. 	Here the intent is to show that the status of all the reservations is coherent.}
	\end{adjustwidth}
\end{figure}
	...
	\begin{adjustwidth} {-3cm}{}
		...
		\caption{Customer reservations.\newline Here is shown how constraints on customer's ability to make a reservation are respected.}
	\end{adjustwidth}
\end{figure}
