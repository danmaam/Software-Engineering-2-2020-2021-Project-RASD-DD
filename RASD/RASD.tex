	...
	%Following this brief introduction of the application scope, there are %the Phenomenon involved in the system.
		...
		\begin{center}
			...
			\begin{tabular}[h!]{|m{2.5em}|m{32.5em}|}
				...
				\xrowht{5pt}
				G8 & Allow store managers to decide how many people to have in the store and in which department \\
				\xrowht{5pt}
				...
				\xrowht{5pt}
				G11 & Allow to manage optimally the influx in the building \\
				\hline
...
\section{Overall Description}
	...
	In the previous chapter there were introduced, sketchily, the main features of the software in order to understand, in general, its functioning. Alternatively, in this section will be illustrated and described accurately all the functions that the software allows to do.
		...
		The app, also, allows store managers to see the store's affluency and to modify the store capacity in every single departmente. When a department capacity is changed, the latest overflowing bookings will be cancelled, and a notify is sent to the customer, proposing him other comfortable options for the same preferences. \\
			...
			\begin{center}
				...
				\begin{adjustwidth}{-1.5cm}{}
					\begin{tabular}[h!]{|m{2.5em}|m{32.5em}|}
						...
						\xrowht{5pt}
						DA13 & Each customer enters the supermarket only through the allowed entries \\
						\hline
			...
			\begin{center}
				...
				\begin{adjustwidth}{-1.5cm}{}
					\begin{longtable}[h!]{|m{2.5em}|m{32.5em}|}
						...
						\xrowht{5pt}
						R2 & The system must allow store managers to register his store \\
						\xrowht{5pt}
						...
						\xrowht{5pt}
						R6 & The system must save the store managers data registration \\
						\xrowht{5pt}
						...
						\xrowht{5pt}
						R22 & The store manager can handle the booking of each customer \\
						\xrowht{5pt}
						R23 & The store manager can handle the opening and closing time of the store \\
						\xrowht{5pt}
						R24 & The system knows the situation in real time of each store \\
						\xrowht{5pt}
						R25 & The system takes trace of each customer entry and exit from the store \\
						\xrowht{5pt}
						R26 & The system contains a list of bookable stores \\
						\xrowht{5pt}
						R27 & The system allows to get a ticket from a physical dispenser \\
						\xrowht{5pt}
						R28 & The system can reasonably estimate the time needed from a specific user to complete his shopping \\
						\xrowht{5pt}
						R29 & The system must save clients’ tickets \\
						\xrowht{5pt}
						R30 & The system should estimate when it must stop generating other tickets to avoid turns after the closing time of the store \\
						\hline
