...
\section{Architectural Design}
	...
	A store manager may also see the situation inside their store. To do this, a request to the {\bfseries ParameterComponent} is made, the \emph{DBMS} queried for the situation, and the details than sent to the {\bfseries MobileApp}, where they will be elaborated.

	\begin{figure}[H]
		\begin{adjustwidth} {-0.5cm}{}
			\centering
			\includegraphics[scale=0.4]{Sequence Diagrams/sd__ViewStoreSituation__ViewStoreSituation.png}
			\end{adjustwidth}
